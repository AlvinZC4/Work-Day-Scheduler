$(document).ready(function() {
    ...
    // An array that contains every possible hour of the day, this is used to help define items in local storage
    ...
    // function for one block (hour) of the calendar to render data from local stroage and show it on the block
    ...
    // Executes the renderStoredData function for every hour shown on the calendar when called (line 168)
    ...
    // A function to create an eventListener for the save button on the calendar; saves data to local storage
    ...
    // Execute the saveData function for each hour shown on the calendar
    ...
    // Am eventListener for the "Clear Calendar" button to clear local storage and remove any saved text from the calendar
...
// Call the renderAllStored function to bring in any data from local storage
renderAllStored();
